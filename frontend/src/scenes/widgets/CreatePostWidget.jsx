...
// Component Création de post par un user Formulaire, dropzone image + icons + btn createPost
const CreatePostWidget = ({ picturePath }) => {
  ...
  return (
    <WidgetWrapper>
      ...
      {/* DROPZONE Si image clickée faire apparaitre Box*/}
      {isImage && (
        <Box
